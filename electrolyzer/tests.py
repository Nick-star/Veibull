...
from .models import ElectrolyzerType

# Create your tests here.
class ElectrolyzerTypeTestCase(TestCase):
    def setUp(self):
        self.electrolyzer_type = ElectrolyzerType.objects.create(name='Type 1')
    ...
    def test_add_electrolyzer_type(self):
        ...
        electrolyzer_type = ElectrolyzerType.objects.filter(name='Type 2').first()
